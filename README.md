...
| 🍲 | **找到同伴** | 食材卡三個情境任務，全部從新生的角度出發：外食一週、熬夜爆肝、一個人在外地——走進伙食團，這些都有得救 |
| 🤝 | **實踐服務** | 三隻猴子：一個閉眼、一個只能比、一個只能說。收尾放仲由夫子那段話，再把社團做過的服務照片鋪滿投影幕 |
...
沒設定 Firebase 也不會壞：投影幕會自動退到本機模式，鍵盤照樣跑完全部 52 個畫面，
只是手機端不會同步。
